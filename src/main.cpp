...
uint256 hashGenesisBlock("0x09e8f51decbe9ce55f898698e54b42b3326646f49e329f610db45b26334f0256");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 50 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 100); // Oryxcoin: 50 blocks in ~4 years
...
static const int64 nTargetSpacing = 2.5 * 60; // Oryxcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
	...
	{
	   static const int64 nTargetTimespan = 60 * 60; // 1 hours
	   static const int64 nTargetSpacing = 30; // .5 minutes
	   static const int64 nInterval = nTargetTimespan / nTargetSpacing;
	}
	else
	{
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Oryxcoin data with full node";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x9ae3db0f9abd186b60d4e556a2ba56a1f40546459995175602f08cefbfa0a582"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Oryxcoin: increase each by adding 2 to bitcoin's value.
